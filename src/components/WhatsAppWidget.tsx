...
const WA_LINK = 'https://wa.me/message/G4IAP3EAAF7JA1';
...
function WhatsAppIcon() {
  return (
    ...
    >
      ...
      <path d="M12 0C5.373 0 0 5.373 0 12c0 2.125.558 4.122 1.532 5.854L0 24l6.317-1.508A11.956 11.956 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.818 9.818 0 01-5.003-1.373l-.36-.214-3.724.888.938-3.616-.235-.372A9.818 9.818 0 1112 21.818z" />
    </svg>
  );
}
